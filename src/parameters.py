...
the_dict = {'hp':param.param(), 'd':'cw.pl', 'e':[], 'n':[features.beW, features.bbW, features.ayW, features.xW, features.vW, features.uW, features.wW, features.zW], 'co':5, 'pdb_name':'12as', 'chain_letter':'A', 'reg':100, 'mfmi':20, 'wif':2, 'wfld':0, 'nfld':2, 'ns':2, "wob":0, 'wob2':2, 'evalue':1e-10, 'pos1':1, 'pos2':2, 'wreg':1, 'trun':99, 'wclf':objects.pW, 'svmC':10, 'lgn':9, 'lgc':5, 'pos':45, 'nwc':-1.0, 'micut':5, 'wtpr':0, 'posw':150, 'sfc':1, 'self':False, 'mx':50, 'ok':3, 'ik':2, 'md':1, 'tj':1, 'wj':0, 'hpvf':'test_hp'}
